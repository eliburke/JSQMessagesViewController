...
- (void)setSendButtonDisabled:(BOOL)sendButtonDisabled
{
    _sendButtonDisabled = sendButtonDisabled;
    [self updateSendButtonEnabledState];
}
...
{
    BOOL enabled = self.sendButtonDisabled == NO && [self.contentView.textView hasText];
